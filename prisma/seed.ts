...
async function main() {
  ...
  const attendances = await prisma.dailyAttendance.createMany({
    data: [
      ...
      {
        title: "100설기 들어옴 - 2024 1월 - 0",
        status: "PRESENT",
        createdAt: new Date("2024-01-03T09:01:56"),
        updatedAt: new Date("2024-01-04T14:01:56"),
        seolgiId: 1,
        objectiveId: 1,
        userId: testSeolgi.id,
      },
      {
        title: "100설기 들어옴 - 2024 1월 - 1",
        status: "PRESENT",
        createdAt: new Date("2024-01-05T14:01:56"),
        updatedAt: new Date("2024-01-05T14:01:56"),
        seolgiId: 1,
        objectiveId: 1,
        userId: testSeolgi.id,
      },
      {
        title: "100설기 들어옴 - 2024 1월 - 2",
        status: "PRESENT",
        createdAt: new Date("2024-01-06T15:01:56"),
        updatedAt: new Date("2024-01-07T14:01:56"),
        seolgiId: 1,
        objectiveId: 1,
        userId: testSeolgi.id,
      },
      {
        title: "100설기 들어옴 - 2024 1월 - 3",
        status: "PRESENT",
        createdAt: new Date("2024-01-07T15:01:56"),
        updatedAt: new Date("2024-01-08T14:01:56"),
        seolgiId: 3,
        objectiveId: 1,
        userId: testSeolgi.id,
      },
      {
        title: "100설기 들어옴 - 2024 1월 - 4",
        status: "PRESENT",
        createdAt: new Date("2024-01-08T15:01:56"),
        updatedAt: new Date("2024-01-09T14:01:56"),
        seolgiId: 2,
        objectiveId: 1,
        userId: testSeolgi.id,
      },
      {
        title: "100설기 들어옴 - 2024 1월 - 5",
        status: "PRESENT",
        createdAt: new Date("2024-01-10T15:01:56"),
        updatedAt: new Date("2024-01-11T14:01:56"),
        seolgiId: 2,
        objectiveId: 1,
        userId: testSeolgi.id,
      },
